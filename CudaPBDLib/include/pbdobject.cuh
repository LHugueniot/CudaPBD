...
{
public:
    devicePBDobj(PBDobject _originalObj);


    thrust::device_vector<float3> m_pointPosDevice;

    thrust::device_vector<float3> m_pointVelDevice;

    thrust::device_vector<float> m_pointMassDevice;

    thrust::device_vector<float> m_pointInvMassDevice;

    thrust::device_vector<uint> m_distanceConstraintDevice;

    thrust::device_vector<float> m_distanceConRestLengthDevice;

    thrust::device_vector<uint> m_bendingConstraintDevice;

    thrust::device_vector<float> m_bendingConRestLengthDevice;

    thrust::device_vector<uint> m_facePointsDevice;

    PBDobject m_originalObj;
};
